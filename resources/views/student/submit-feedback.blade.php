...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-lg p-8">
        ...
        <form method="POST" action="{{ route('student.feedback.store') }}" class="space-y-6" onsubmit="return confirm('Are you sure you want to submit this feedback?');">
            @csrf
            <div>
                <label for="feedbackType" class="block text-sm font-medium text-gray-700 mb-2">Feedback Type</label>
                <select name="feedbackType" id="feedbackType" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div>
                ...
                <input type="text" name="subject" id="subject" required maxlength="100" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Brief subject of your feedback">
            </div>

            <div>
                <label for="feedbackText" class="block text-sm font-medium text-gray-700 mb-2">Message</label>
                <textarea name="feedbackText" id="feedbackText" required maxlength="255" rows="6" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Describe your feedback in detail"></textarea>
            </div>
